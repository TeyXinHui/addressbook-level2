    ...
    public void addCommand_invalidAddress_throwsException() {
        ...
        for (String address : invalidAddresses) {
            assertConstructingInvalidAddCmdThrowsException(Name.EXAMPLE, Phone.EXAMPLE, true, Email.EXAMPLE,
                    true, address, true, Birthday.EXAMPLE, false, EMPTY_STRING_LIST);
        }
    }

    @Test
    public void addCommand_invalidBirthday_throwsException() {
        final String[] invalidBirthdays = { "", " " , "19", "/", "14/12", "11/2008", "1999", "hih/hihj/jij", "ewef/23/dfw", "12//12"};
        for (String birthday : invalidBirthdays) {
            assertConstructingInvalidAddCmdThrowsException(Name.EXAMPLE, Phone.EXAMPLE, true, Email.EXAMPLE,
                    true, Address.EXAMPLE, false, birthday, false, EMPTY_STRING_LIST);
        }
    }
