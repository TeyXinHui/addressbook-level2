...
public class AddressBookTest {
    ...
    public void setUp() throws Exception {
        ...
        aliceBetsy     = new Person(new Name("Alice Betsy"),
                                    ...
                                    new Address("8, Computing Drive, #07-09, 868972", false),
                                    new Birthday("12/11/1987", false),
        ...
        bobChaplin     = new Person(new Name("Bob Chaplin"),
                                    ...
                                    new Address("9, Computing Drive, #06-08, 517151", false),
                                    new Birthday("03/02/1967", false),
                                    new UniqueTagList(tagMathematician));

        charlieDouglas = new Person(new Name("Charlie Douglas"),
                                    new Phone("98751365", false),
                                    new Email("charlie@nusgdg.org", false),
                                    new Address("10, Science Drive, #01-02, 179178", false),
                                    new Birthday("09/02/1995", false),
        ...
        davidElliot    = new Person(new Name("David Elliot"),
                                    ...
                                    new Address("11, Arts Link, #06-04, 851891", false),
                                    new Birthday("10/12/1789", false),
