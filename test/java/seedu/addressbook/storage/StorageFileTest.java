...
public class StorageFileTest {
    ...
    private AddressBook getTestAddressBook() throws Exception {
        ...
        ab.addPerson(new Person(new Name("John Doe"),
                                ...
                                new Address("123, John street, #01-01, 124987", false),
                                new Birthday("08/05/1879", false),
                                new UniqueTagList(Collections.emptySet())));
        ab.addPerson(new Person(new Name("Betsy Crowe"),
                                new Phone("1234567", true),
                                new Email("betsycrowe@gmail.com", false),
                                new Address("234, Newgate Prison, #99-22, 123498", true),
                                new Birthday("18/05/1879", false),
